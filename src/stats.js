  ...
  return [
    {
      ...
      icon: "👑",
      image: "./assets/badges/merdivenler_krali.jpg",
    ...
    },
    {
      ...
      name: "Roket Tırmanış",
      icon: "🚀",
      image: "./assets/badges/roket_tirmanis.jpg",
    ...
    },
    {
      ...
      name: "Yüzler Kulübü",
      icon: "💯",
      image: "./assets/badges/yuzler_kulubu.jpg",
    ...
    },
    {
      ...
      icon: "🎯",
      image: "./assets/badges/istikrar_abidesi.jpg",
    ...
    },
    {
      ...
      name: "Futbol Cahili",
      icon: "🥄",
      image: "./assets/badges/futbol_cahili.jpg",
...
export function getLeagueBadgesOverview(leagueData, targetGw = null) {
  ...
  // 5. 🥄 Futbol Cahili (Haftanın en düşük puanını alanlar)
  const cahilHolders = [];
  const lowestCounts = {};
